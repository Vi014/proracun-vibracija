...
#pragma warning disable IDE1006 // dobijam upozorenje ako koristim PascalCasing za public promenljive i camelCasing za private promenljive, a ne ako uradim suprotno???
        ...
        public String[] Jezik = {
                                ...
                                "Immediately after doing an engine loaded test, run in neutral for 3 minutes at a slightly elevated RPM to cool the \r\ntransmission.",
                                "Back",
                                "Engine Accessory Test",
                                ...
                                "Noise and vibrations have some characteristics in common:",
                                ...
                                "The phenomenon of resonance means that the presence of one small vibration may create another very large vibration that can be \r\nfelt in the vehicle.",
                                "Transmission of vibrations and sound",
                                ...
                                "In most cases, the NVH issue is resolved by fixing the source of the vibrating force, but sometimes any change in transmission \r\nprocess can solve the issue.",
                                ...
                                "By repairing elastic contact between exhaust and body, the NVH problem will be resolved.",
                                "Measuring the frequency",
                                "In order to find the source of vehicle vibrations it is necessary to measure the vibrating frequency and engine/vehicle speed at which \r\nthat vibration frequency occurs. There are many tools for this purpose as shown in the figures below.",
                                ...
                                "      - an out of balance flywheel or excesisve runout",
                                "      -",
                                "Crankshaft pulley (Torsional vibration dampener)",
                                "      - Cylinder to cylinder mass difference",
                                "      -",
                                "Torque converter",
                                "      - an imbalanced crankshaft", // 336
                                "Crankshaft pulley (Torsional vibration dampener)",
                                "An out of balance or out of round TVD will transfer engine vibrations to the belt drive. An improper TVD (figure 1) will fail to dampen \r\ncrankshaft vibrations, which will be transferred to the belt drive.",
                                "Figure 1a (TVD as specified)",
                                "Figure 1b (Improper TVD)",
                                "Torque converter",
                                "The torque converter frrequency is equal to the engine frequency. The torque converter can be suspected as the cause of noise or \r\nvibration when an NVH concern is torque sensitive.",
                                ...
                                "      - Torque converter imabalnce or an incorrectly installed converter",
                                "Second order",
                                ...
                                "engine firing frequency",
                                "Engine firing frequency",
                                "Firing frequency refers to the force created by the engine each time the cylinder fires. This is the natural vibration of the internal \r\ncombustion engine. Firing frequency is load dependent. The higher the engine load is, the more prominent the frequency will be. \r\nIf there is a problem on the engine, which is affecting the combustion process, this vibration will increase.",
                                "Even though firing frequency is natural to ICE, it has to be isolated from the vehicle body.",
                                "Firing frequency vibrations could be caused by:",
                                "      -",
                                "Engine mounts",
                                "      -",
                                "Exhaust hangers",
                                "      - Engine problems, affecting the combustion process",
                                "Engine mounts",
                                "The first components that isolate the passenger comprartment from engine vibrations are engine mounts. Any fault in the engine \r\nmounting system can directly lead to noise and vibration.",
                                "Inspect the engine mounts for cracks or damage to the insulator and the bracket (figure 2). Grounded, the engine mount bracket \r\ncontacting the frame-mounted bracket, or strained engine mounts may not isolate engine vibrations.",
                                "Engine mounts must be installed correctly and tightened with the specific torque. If the mounts are installed incorrectly or incorrect \r\nparts are used, they won't be able to absorb engine vibrations. Make sure the proper type of engine mount is installed. (figure 3)",
                                "Figure 2",
                                "Figure 3",
                                "Exhaust hangers",
                                ...
                                "Driveshaft vibrations can be classified into three different orders: first-order, second-order, and fourth-order.",
                                ...
                                "A second-order vibration may be caused by a:  \r\n      - Driveshaft angle \r\n      - U-joint cancelation \r\n      - Worn CV or U joint",
                                ...
                                "Driveshaft runout",
                                "Place the dial indicator at a 90 degree angle from the driveshaft and measure the runout at the ends of the driveshaft (figure 1), as \r\nwell as in the middle of the shaft (figure 2).",
                                "Figure 1",
                                "Figure 2",
                                "If the measured values are not within vehicle manufacturer specifications (typically 0.5 mm at the ends and 0.6 mm at the middle), \r\nreplace the driveshaft.",
                                "Back",
                                "Missing balance weights",
                                ...
                                "A higher order wheel frequency indicates several independent first order issues or a problem with: \r\n      - The joint between the wheels and the driveshaft \r\n      - Non-uniform tires on the vehicle \r\n      - Radial force variation",
                                "Check the following:",
                                "      -",
                                ...
                                "Bent axle shaft",
                                "      -",
                                "The joint between the wheels and the axle shaft",
                                "Radial wheel and tire assembly runout",
                                "Radial runout can be measured on the vehicle (hub, wheel and tire total runout).",
                                "Raise the vehicle, apply masking tape on the circumference of the tire (figure 1), and check the runout with a dial gauge. \r\nThe measured value should be compared to the vehicle manufacturer's data (the maximum is typically 0.8 to 1 mm).",
                                "Radial runout can also be measured off the vehicle. In this case the hub can be ruled out.",
                                "Figure 1",
                                "If the measured value is above specifications, the problem could be in the tire, wheel, or hub.",
                                ...
                                "Back",
                                "Lateral wheel and tire assembly runout",
                                "Measure the lateral runout with the dial gauge positioned on the flat surface of the tire sidewall (figure 2).",
                                "The measured value should be compared to the vehicle manufacturer's data (the maximum is typically 0.8 to 1.2 mm).",
                                "Figure 2",
                                "If the measured value is above specifications, the problem could be in the tire, wheel, or hub.",
                                "Proceed with lateral runout measurements.",
                                "Back",
                                "Radial wheel runout",
                                "Radial wheel runout could be measured while the wheel is on the vehicle (wheel and hub total runout), or with the wheel off the \r\nvehicle (only the wheel runout). Place the dial gauge and measure the runout (figure 3).",
                                "The measured value should be compared to the vehicle manufacturer's data (the maximum is typically 0.25 mm for alloy wheels and \r\n0.5 mm for steel wheels).",
                                "Figure 3",
                                "If the measured value is above specifications, the problem could be in the wheel or the hub.",
                                "Proceed with radial runout measurements.",
                                "If the value is within specifications, the problem is in the tire.",
                                "Back",
                                "Lateral wheel runout",
                                "Lateral wheel runout could be measured whiel the wheel is on the vehicle (wheel and hub total runout), or with the wheel off the \r\nvehicle (only the wheel runout). Place the dial gauge and measure the runout (figure 4).",
                                "The measured value should be compared to the vehicle manufacturer's data (the maximum is typically 0.5 to 0.8 mm).",
                                "Figure 4",
                                "If the measured value is above specifications, the problem could be in the wheel or the hub.",
                                ...
                                "If the measured value on the hub is within specifications, the problem is on the wheel.",
                                "If the measured value of the vehicle is within specifications, the problem is on the hub.",
                                "Figure 5",
                                "Figure 6",
                                "Back",
                                "Radial force variation",
                                ...
                                "If the sidewall stiffness of the tire is not uniform (figure 7), a vertical force is exerted on the axle making it move up and down. \r\nThis movement creates vibrations unrelated to wheel balance.",
                                "Figure 7",
                                ...
                                "Back",
                                "Bent axle shaft",
                                "Place the dial indicator at a 90 degree angle from the axle shaft and measure the runout at the ends of the axle shaft, as well as in \r\nthe middle of the shaft (figure 9).",
                                "Figure 9",
                                "If the measured values are not within the vehicle manufacturer's specifications, replace the shaft."
                                };
